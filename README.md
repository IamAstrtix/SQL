...
**7). JOIN** statement is used to combine data or rows from two or more tables based on a
...
**19). SQL Query to pivot data from rows to columns, showing the total sales for each product
category by month.**
